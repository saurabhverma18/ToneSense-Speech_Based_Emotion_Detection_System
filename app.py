...
def main():
    ...
    if website_menu == "Emotion Recognition":
        ...
        model_type = st.sidebar.selectbox("Model used for prediction", ("mfccs",))
        ...
        link = '[GitHub repository of the web-application]' \
               '(https://github.com/saurabhverma18/ToneSense-Speech_Based_Emotion_Detection_System)'
        st.markdown(link, unsafe_allow_html=True)

        st.subheader("Theory")
        link = '[Theory behind - Medium article]' \
               '(https://medium.com/@qqqqq1840/classifying-emotions-using-audio-recordings-and-python-59b35445e18e)'
        st.markdown(link + ":clap::clap::clap: Saurabh", unsafe_allow_html=True)
        ...
        with col1:
            st.info("saurabhverma1523@gmail.com")
            st.info("mmadhureshkumar98@gmail.com")
            st.info("ranjeetyadav@gmail.com")
            st.info("yashsinghal11@gmail.com")
        with col2:
            liimg = Image.open("images/LI-Logo.png")
            st.image(liimg)
            st.markdown(f""":speech_balloon: [Saurabh Verma](https://www.linkedin.com/in/saurabhverma18/)""",
                        unsafe_allow_html=True)
            st.markdown(f""":speech_balloon: [Madhuresh Verma](https://www.linkedin.com/in/madhuresh-verma-309bb4257/)""",
                        unsafe_allow_html=True)
            st.markdown(f""":speech_balloon: [Ranjeet Kumar Yadav](https://www.linkedin.com/in/ranjeet-kumar-yadav-7721492ba/)""",
                        unsafe_allow_html=True)
            st.markdown(f""":speech_balloon: [Yash Singhal](https://www.linkedin.com/in)""",
                        unsafe_allow_html=True)
        ...
        if st.button("Submit"):
            st.success(f"Feedback was sent")
        ...
        if st.button("Get Random Quotes"):
            with st.beta_container():
                ...
                with col1:
                    quotes = {
                            "Self-Belief": "Believe in yourself and all that you are. Know that there is something inside you that is greater than any obstacle.",
                            "Courage": "Success is not final, failure is not fatal: It is the courage to continue that counts.",
                            "Persistence": "Don’t watch the clock; do what it does. Keep going.",
                            "Dreams": "The future belongs to those who believe in the beauty of their dreams.",
                            "Possibility": "The only way to achieve the impossible is to believe it is possible.",
                            "Optimism": "Keep your face always toward the sunshine—and shadows will fall behind you.",
                            "New Beginnings": "You are never too old to set another goal or to dream a new dream."
                        }
